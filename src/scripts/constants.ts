...
},
{
  ...
  'ruleDescription': 'Transaction includes a currency that is designated as high risk. Mostly relevant for when you are moving funds between different currencies. This rule uses a customizable list.',
  'ruleAction': 'BLOCK',
  'ruleHit': Math.random() < 0.5,
},
{
  ...
  'ruleDescription': '>= x number of low value incoming transactions just below (minus amount of z) a specific threshold (y) to a user (your user is receiving the funds). Very useful and common for structured money laundering attempts. This is a recommended rule.',
  'ruleAction': 'FLAG',
  'ruleHit': Math.random() < 0.5,
},
{
  ...
  'ruleDescription': '>= x number of low value outgoing transactions just below (minus amount of z) a specific threshold (y) from a user (your user is sending the funds). Very useful and common for structured money laundering attempts. This is a recommended rule.',
  'ruleAction': 'FLAG',
  'ruleHit': Math.random() < 0.5,
},
{
  ...
  'ruleDescription': 'More than x users transacting with a single counterparty over a set period of time t (E.g. Nigerian prince scam outbound)',
  'ruleAction': 'FLAG',
  'ruleHit': Math.random() < 0.5,
},
{
  ...
  'ruleDescription': 'More than x counterparties transacting with a single user over a set period of time t (E.g. Nigerian prince scam inbound)',
  'ruleAction': 'FLAG',
  'ruleHit': Math.random() < 0.5,
}]