...
export default function SearchResultDetailsModal(props: Props) {
  ...
  return (
    <Modal width={1500} visible={Boolean(hit)} onCancel={onClose} footer={null}>
      <Card.Section>
      ...
      >
        {sourceFields.map((source) => {
          console.log(hit.doc?.source_notes, source.source);
              ...
              <ProDescriptions column={1} colon={false} layout="horizontal">
                ...
                <ProDescriptions.Item label={<b>Source</b>}>
                  <Space>
                    ...
                    <Tag color={isRemoved ? 'green' : 'red'}>{isRemoved ? 'Removed' : 'Live'}</Tag>
                  </Space>
                </ProDescriptions.Item>
