...
export class DefaultApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async getDashboardStatsHitsPerUser(
    ...
    // Path Params
    const localVarPath = '/dashboard_stats/hits_per_user';
   ...
   */
  public async getPulseManualRiskAssignment(
    userId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
    ...
    // verify required parameter 'userId' is not null or undefined
    if (userId === null || userId === undefined) {
      throw new RequiredError('DefaultApi', 'getPulseManualRiskAssignment', 'userId');
    }

    // Path Params
    const localVarPath = '/pulse/manual-risk-assignment';
   ...
   */
  public async getPulseRiskClassification(_options?: Configuration): Promise<RequestContext> {
    let _config = _options || this.configuration;

    // Path Params
    const localVarPath = '/pulse/risk-classification';
   ...
   * Tenant - Get Settings
   */
  public async getTenantsSettings(_options?: Configuration): Promise<RequestContext> {
    let _config = _options || this.configuration;
  ...
  public async getTransactionsListExport(
    ...
    // verify required parameter 'limit' is not null or undefined
    if (limit === null || limit === undefined) {
      throw new RequiredError('DefaultApi', 'getTransactionsListExport', 'limit');
    }

    // verify required parameter 'skip' is not null or undefined
    if (skip === null || skip === undefined) {
      throw new RequiredError('DefaultApi', 'getTransactionsListExport', 'skip');
    }

    // verify required parameter 'beforeTimestamp' is not null or undefined
    if (beforeTimestamp === null || beforeTimestamp === undefined) {
      throw new RequiredError('DefaultApi', 'getTransactionsListExport', 'beforeTimestamp');
    }
   ...
   */
  public async postTenantsSettings(
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(TenantSettings, 'TenantSettings', ''),
      contentType,
    );
    requestContext.setBody(serializedBody);
   ...
   */
  public async pulseManualRiskAssignment(
    userId: string,
    ...
    // verify required parameter 'userId' is not null or undefined
    if (userId === null || userId === undefined) {
      throw new RequiredError('DefaultApi', 'pulseManualRiskAssignment', 'userId');
    }
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    const serializedBody = ObjectSerializer.stringify(
      ObjectSerializer.serialize(ManualRiskAssignmentPayload, 'ManualRiskAssignmentPayload', ''),
      contentType,
    );
    requestContext.setBody(serializedBody);
...
export class DefaultApiResponseProcessor {
   ...
   * to the expected objects
   *
   * @params response Response returned by the server for a request to getDashboardStatsHitsPerUser
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async getDashboardStatsHitsPerUser(
    response: ResponseContext,
    ...
    const contentType = ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if (isCodeInRange('200', response.httpStatusCode)) {
      const body: DashboardStatsHitsPerUser = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
        'DashboardStatsHitsPerUser',
        '',
      ) as DashboardStatsHitsPerUser;
      return body;
    }
   ...
   * to the expected objects
   *
   * @params response Response returned by the server for a request to getPulseManualRiskAssignment
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async getPulseManualRiskAssignment(
    response: ResponseContext,
   ...
   * to the expected objects
   *
   * @params response Response returned by the server for a request to getTenantsSettings
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async getTenantsSettings(response: ResponseContext): Promise<TenantSettings> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if (isCodeInRange('200', response.httpStatusCode)) {
      const body: TenantSettings = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
        'TenantSettings',
        '',
      ) as TenantSettings;
   ...
   * to the expected objects
   *
   * @params response Response returned by the server for a request to getTransactionsListExport
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async getTransactionsListExport(response: ResponseContext): Promise<InlineResponse200> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if (isCodeInRange('200', response.httpStatusCode)) {
   ...
   * to the expected objects
   *
   * @params response Response returned by the server for a request to postTenantsSettings
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async postTenantsSettings(response: ResponseContext): Promise<TenantSettings> {
    const contentType = ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if (isCodeInRange('200', response.httpStatusCode)) {
      const body: TenantSettings = ObjectSerializer.deserialize(
        ObjectSerializer.parse(await response.body.text(), contentType),
   ...
   * to the expected objects
   *
   * @params response Response returned by the server for a request to pulseManualRiskAssignment
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async pulseManualRiskAssignment(
    response: ResponseContext,
