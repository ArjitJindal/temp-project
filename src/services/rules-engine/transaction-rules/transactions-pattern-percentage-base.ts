...
export default class TransactionsPatternPercentageBaseRule extends TransactionRule<TransactionsPatternPercentageRuleParameters> {
  transactionRepository?: TransactionRepository

  public static getSchema(): JSONSchemaType<TransactionsPatternPercentageRuleParameters> {
    return {
      type: 'object',
      properties: {
        transactionState: {
