...
import { useRuleInstanceRecommendation, useUpdateRuleInstance } from '@/utils/api/rules';
...
export default function RuleThresholdRecommendation(props: Props) {
  ...
  const recommendationResult = useRuleInstanceRecommendation(ruleInstance.id ?? '');
