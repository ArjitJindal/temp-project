...
import { ModelServingStackConfig, ModelDetails } from '../../../lib/utils/types'
...
export class ModelServingStack extends BaseStack {
  constructor(
    ...
    stackConfig: ModelServingStackConfig
  ) {
    ...
    const modelConfigList: VariantConfigProps[] = []
  ...
  private deployEndpoint(props: EndpointProps): string {
    ...
    const _ = new sagemaker.CfnEndpoint(
      this,
