...
import { BUSINESS_DIRECTORS_COUNTRY_OF_NATIONALITY_RISK_FACTOR } from '../../user/directors-country-of-nationality'
...
describe('Country of Nationality Risk Factor', () => {
  ...
  test('V8 result should be equivalent to V2 result', async () => {
    const riskFactor = {
      ...
      parameter: 'directors' as RiskFactorParameter,
      isDerived: false,
    ...
    const v8RiskFactor: RiskFactor = {
      ...
      riskLevelLogic: (
        getRiskFactorLogicByKeyAndType('directors', 'BUSINESS') ?? (() => [])
      )({
  ...
  test('V8 result should handel undefined directors country of nationality', async () => {
    const riskFactor = {
      ...TEST_BUSINESS_USER_RISK_PARAMETER,
      parameter: 'directors' as RiskFactorParameter,
      isDerived: false,
  ...
  test('V8 result should handel empty directors country of nationality', async () => {
    const riskFactor = {
      ...TEST_BUSINESS_USER_RISK_PARAMETER,
      parameter: 'directors' as RiskFactorParameter,
      isDerived: false,
