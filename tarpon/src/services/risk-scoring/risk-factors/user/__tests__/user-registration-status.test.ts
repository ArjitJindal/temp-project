...
import { BUSINESS_USER_REGISTRATION_STATUS_RISK_FACTOR } from '../../user/user-registration-status'
...
describe('User Segment Risk Factor', () => {
  ...
  test('V8 result should be equivalent to V2 result', async () => {
    const riskFactor = {
      ...
      parameter:
        'legalEntity.companyGeneralDetails.userRegistrationStatus' as RiskFactorParameter,
      isDerived: false,
  ...
  test('V8 result should handel empty userRegistrationStatus', async () => {
    const riskFactor = {
      ...TEST_BUSINESS_USER_RISK_PARAMETER,
      parameter:
        'legalEntity.companyGeneralDetails.userRegistrationStatus' as RiskFactorParameter,
    ...
    const businessUser: InternalBusinessUser = {
      ...
      legalEntity: {
        ...
        companyGeneralDetails: {
          ...getTestBusiness().legalEntity.companyGeneralDetails,
          userRegistrationStatus: '' as UserRegistrationStatus,
        },
      },
    }
    const mongoDb = await getMongoDbClient()
  ...
  test('V8 result should handel undefined userRegistrationStatus', async () => {
    const riskFactor = {
      ...TEST_BUSINESS_USER_RISK_PARAMETER,
      parameter:
        'legalEntity.companyGeneralDetails.userRegistrationStatus' as RiskFactorParameter,
