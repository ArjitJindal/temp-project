...
import { TRANSACTION_DESTINATION_CURRENCY_RISK_FACTOR } from '../destination-currency'
...
dynamoDbSetupHook()
describe('Destination Currency TRANSACTION Risk Factor', () => {
  ...
  test('V8 result should handle null Destination Currency', async () => {
    const riskFactor = TEST_TRANSACTION_RISK_PARAMETERS[0]
