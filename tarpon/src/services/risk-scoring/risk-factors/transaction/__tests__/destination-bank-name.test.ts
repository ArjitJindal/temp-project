...
describe('Origin Bank Name TRANSACTION Risk Factor', () => {
  ...
  test('Basic case', async () => {
    const riskFactor = {
      ...
      parameter: 'destinationPaymentDetails.bankName' as RiskFactorParameter,
      isDerived: true,
  ...
  test('V8 result should handle empty Destination BankName', async () => {
    const riskFactor = {
      ...TEST_TRANSACTION_RISK_PARAMETERS[0],
      parameter: 'destinationPaymentDetails.bankName' as RiskFactorParameter,
      isDerived: true,
  ...
  test('V8 result should handle null Destination BankName', async () => {
    const riskFactor = {
      ...TEST_TRANSACTION_RISK_PARAMETERS[0],
      parameter: 'destinationPaymentDetails.bankName' as RiskFactorParameter,
      isDerived: true,
