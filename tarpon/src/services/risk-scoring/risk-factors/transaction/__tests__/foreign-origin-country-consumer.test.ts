...
import { TRANSACTION_FOREIGN_ORIGIN_CONSUMER_COUNTRY_RISK_FACTOR } from '../foreign-origin-consumer-country'
...
dynamoDbSetupHook()
describe('Foreign Origin Country Consumer TRANSACTION Risk Factor', () => {
  const tenantId = getTestTenantId()
  test('V8 result should be equivalent to V2 result', async () => {
    const riskFactor = {
      ...TEST_TRANSACTION_RISK_PARAMETERS[0],
      parameter:
        'domesticOrForeignOriginCountryConsumer' as RiskFactorParameter,
      isDerived: true,
  ...
  test('V8 result should handle null transaction country for foreign origin country consumer', async () => {
    const riskFactor = {
      ...TEST_TRANSACTION_RISK_PARAMETERS[0],
      parameter:
        'domesticOrForeignOriginCountryConsumer' as RiskFactorParameter,
  ...
  test('V8 result should handle null user country for foreign origin country consumer', async () => {
    const riskFactor = {
      ...TEST_TRANSACTION_RISK_PARAMETERS[0],
      parameter:
        'domesticOrForeignOriginCountryConsumer' as RiskFactorParameter,
  ...
  test('V8 result should handle null user country and transaction country for foreign origin country consumer', async () => {
    const riskFactor = {
      ...TEST_TRANSACTION_RISK_PARAMETERS[0],
      parameter:
        'domesticOrForeignOriginCountryConsumer' as RiskFactorParameter,
