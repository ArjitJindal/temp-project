...
import { TRANSACTION_DESTINATION_COUNTRY_RISK_FACTOR } from '../destination-country'
...
dynamoDbSetupHook()
describe('Destination Country TRANSACTION Risk Factor', () => {
  const tenantId = getTestTenantId()
  test('Basic case', async () => {
    const riskFactor = TEST_TRANSACTION_RISK_PARAMETERS[1]
  ...
  test('V8 result should handle null Destination Country', async () => {
    const riskFactor = TEST_TRANSACTION_RISK_PARAMETERS[1]
