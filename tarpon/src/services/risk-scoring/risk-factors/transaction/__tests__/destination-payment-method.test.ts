...
import { TRANSACTION_DESTINATION_PAYMENT_METHOD_RISK_FACTOR } from '../destination-payment-method'
...
dynamoDbSetupHook()
describe('Destination Payment Method TRANSACTION Risk Factor', () => {
  const tenantId = getTestTenantId()
  test('Basic case', async () => {
    const riskFactor = TEST_TRANSACTION_RISK_PARAMETERS[2]
  ...
  test('V8 result should handle null destination payment method', async () => {
    const riskFactor = TEST_TRANSACTION_RISK_PARAMETERS[2]
