export const ruleNarratives = [
  {
    id: 'R-1',
    narrative:
      'The customer activity was alerted by our transaction monitoring system on mm/dd/yyyy by the rule "First Payment of a customer". The customer was asked to explain and provide supporting documentation for the incoming/outgoing transactions for the amount [Total transaction amount] on mm/dd/yyyy for transaction IDs [Transaction Ids]. The customer did not provide a relevant explanation/is not responsive/or the provided explanations and documentation are not in line with the KYC information we hold on the customer. The activity does not make economic sense and, therefore we find it suspicious and believe that it can be associated with money laundering/terrorist financing.',
  },
  {
    id: 'R-2',
    narrative:
      'The customer activity was alerted by our transaction monitoring system on mm/dd/yyyy by the rule "Transaction amount too high". The customer received/sent [Total transaction amount] between [Case opened date] to [Today] with transaction IDs [Transaction Ids]. The counterparty of the transaction was reviewed and material adverse media was identified via public search ( then explain what exactly adverse media says ). The customer was asked to explain and provide supporting documentation for the transactions for the high amount of [Max transaction amount] on dd/mm/yyyy. The customer did not provide a relevant explanation/is not responsive/or the provided explanations and documentation are not in line with the KYC information we hold on the customer. The activity does not make economic sense and, therefore we find it suspicious and believe that it can be associated with money laundering/terrorist financing.',
  },
  {
    id: 'R-3',
    narrative:
  ...
  },
  {
    id: 'R-16',
    narrative:
      'The customer was alerted by our screening system on mm/dd/yyyy due to a hit against adverse media/PEP/sanctions lists. The customer was investigated and transactional activity was reviewed for the period of [Case start date] to [Today]. The customers were asked to explain and provide supporting documentation for the transactions [Transaction Ids] on [Date customer was asked]. The customers did not provide a relevant explanation/is not responsive/or the provided explanations and documentation are not in line with the KYC information we hold on the customers. The activity does not make economic sense and the customer is a PEP/ we have identified significant adverse media/we have true sanctions hit, therefore we find it suspicious and believe that it can be associated with money laundering/terrorist financing/sanctions evasion.',
  },
  ...
  },
  {
    id: 'R-32',
    narrative:
      'The customer was alerted by our transaction screening system on mm/dd/yyyy due to a hit against adverse media/PEP/sanctions lists found in the bank name field. The customer sent/received [Total transaction amount] between [Case opened date] to [Today]. The customer was asked to explain and provide supporting documentation for the transactions  [Transaction IDs] on [Date customer was asked].  The activity does not make economic sense and we have identified significant adverse media or high-risk activity that was not explained/we have true sanctions hit on the transaction in question, therefore we find it suspicious and believe that it can be associated with money laundering/terrorist financing/sanctions evasion.',
  },
  {
    id: 'R-41',
    narrative:
  ...
  },
  {
    id: 'R-128',
    narrative:
      'The customer was alerted by our screening system on mm/dd/yyyy due to a hit against adverse media/PEP/sanctions lists. The alert was generated on the legal entity name/shareholder/director of the customer. The customer was investigated and transactional activity was reviewed for the period from [Case opened date] to [Today]. . The customer was asked to explain and provide supporting documentation for the transactions and information revealed during screening on mm/dd/yyyy. The customers did not provide a relevant explanation/is not responsive/or the provided explanations and documentation are not in line with the KYC information we hold on the customers. The activity does not make economic sense and the customer is a PEP/ we have identified significant adverse media/we have true sanctions hit, therefore we find it suspicious and believe that it can be associated with money laundering/terrorist financing/sanctions evasion.',
  },
  { id: 'R-129', narrative: 'Blacklisted payment details	N/A' },
  {
    id: 'R-130',
    narrative:
