export const ruleNarratives = [
  {
    id: 'R-1',
    narrative:
      'The customer activity was alerted by our transaction monitoring system on [Case generation date] by the rule "First Payment of a customer". The customer was asked to explain and provide supporting documentation for the incoming/outgoing transactions for the amount [Total transaction amount] on [Date customer was contacted] for transaction IDs [Transaction Ids]. The customer did not provide a relevant explanation/is not responsive/or the provided explanations and documentation are not in line with the KYC information we hold on the customer. The activity does not make economic sense and, therefore we find it suspicious and believe that it can be associated with money laundering/terrorist financing.',
  },
  {
    id: 'R-2',
    narrative:
      'The customer activity was alerted by our transaction monitoring system on [Case generation date] by the rule "Transaction amount too high". The customer received/sent [Total transaction amount] between [Case opened date] to [Case closure date] with transaction IDs [Transaction Ids]. The counterparty of the transaction was reviewed and material adverse media was identified via public search ( then explain what exactly adverse media says ). The customer was asked to explain and provide supporting documentation for the transactions for the high amount of [Total transaction amount] on [Date customer was contacted]. The customer did not provide a relevant explanation/is not responsive/or the provided explanations and documentation are not in line with the KYC information we hold on the customer. The activity does not make economic sense and, therefore we find it suspicious and believe that it can be associated with money laundering/terrorist financing.',
  },
  {
    id: 'R-3',
    narrative:
  ...
  },
  {
    id: 'R-32',
    narrative:
      'The customer was alerted by our transaction screening system on [Case generation date] due to a hit against adverse media/PEP/sanctions lists found in the bank name field. The customer sent/received [Total transaction amount] between [Case generation date] to [Case closure date]. The customer was asked to explain and provide supporting documentation for the transactions  [Transaction IDs] on [Date customer was asked].  The activity does not make economic sense and we have identified significant adverse media or high-risk activity that was not explained/we have true sanctions hit on the transaction in question, therefore we find it suspicious and believe that it can be associated with money laundering/terrorist financing/sanctions evasion.',
  },
  {
    id: 'R-41',
    narrative:
  ...
  },
  {
    id: 'R-128',
    narrative:
      'The customer was alerted by our screening system on [Case generation date] due to a hit against adverse media/PEP/sanctions lists. The alert was generated on the legal entity name/shareholder/director of the customer. The customer was investigated and transactional activity was reviewed for the period from [Case generation date] to [Case closure date]. The customer was asked to explain and provide supporting documentation for the transactions and information revealed during screening on [Date customer contacted]. The customers did not provide a relevant explanation/is not responsive/or the provided explanations and documentation are not in line with the KYC information we hold on the customers. The activity does not make economic sense and the customer is a PEP/ we have identified significant adverse media/we have true sanctions hit, therefore we find it suspicious and believe that it can be associated with money laundering/terrorist financing/sanctions evasion.',
  },
