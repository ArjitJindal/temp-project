  ...
  test('Reviewer chooses to Approve whole Open case', async () => {
    ...
    expect(c2).toMatchObject({
      ...
      alerts: [
        {
          ...
          comments: [
            ...
            {
              userId: 'Flagright System',
              body: 'Alert status changed to Closed. Reasons: Case of this alert was Closed',
            },
          ],
          lastStatusChange: {
            userId: 'ACCOUNT-3',
      ...
      comments: [
        ...
        {
          body: 'Case status changed to Closed',
          userId: 'ACCOUNT-3',
        },
      ],
    })
  ...
  test('Reviewer chooses to Approve the whole Escalated case', async () => {
    ...
    expect(c2).toMatchObject({
      ...
      alerts: [
        {
          ...
          comments: [
            ...
            {
              userId: 'Flagright System',
              body: 'Alert status changed to Escalated. Reasons: Case of this alert was Escalated',
            },
          ],
        },
      ...
      comments: [
        ...
        {
          body: 'Case status changed to Escalated',
          userId: 'ACCOUNT-3',
        },
      ],
    })
