...
const PUBLIC_API_LAMBDA_EXPECTED_MAX_SECONDS = 5
...
export const LAMBDAS: {
  ...
  [StackConstants.CRON_JOB_HOURLY]: {
    codePath: 'cron-job-hourly',
    handlerName: 'cronJobHourlyHandler',
    expectedMaxSeconds: ASYNC_JOB_LAMBDA_EXPECTED_MAX_SECONDS,
    timeoutSeconds: DEFAULT_ASYNC_JOB_LAMBDA_TIMEOUT_SECONDS,
  },
  ...
  [StackConstants.BATCH_RERUN_USERS_CONSUMER_FUNCTION_NAME]: {
    codePath: 'batch-rerun-users-consumer',
    handlerName: 'batchRerunUsersConsumerHandler',
    expectedMaxSeconds: ASYNC_JOB_LAMBDA_EXPECTED_MAX_SECONDS,
    timeoutSeconds: DEFAULT_ASYNC_JOB_LAMBDA_TIMEOUT_SECONDS,
  },
  ...
  [StackConstants.MONGO_UPDATE_CONSUMER_FUNCTION_NAME]: {
    codePath: 'mongo-update-consumer',
    handlerName: 'mongoUpdateConsumerHandler',
    expectedMaxSeconds: ASYNC_JOB_LAMBDA_EXPECTED_MAX_SECONDS,
    timeoutSeconds: DEFAULT_ASYNC_JOB_LAMBDA_TIMEOUT_SECONDS,
  },
  [StackConstants.ACTION_PROCESSING_FUNCTION_NAME]: {
    codePath: 'action-processing',
    handlerName: 'actionProcessingHandler',
    expectedMaxSeconds: ASYNC_JOB_LAMBDA_EXPECTED_MAX_SECONDS,
    timeoutSeconds: DEFAULT_ASYNC_JOB_LAMBDA_TIMEOUT_SECONDS,
  },
  ...
  [StackConstants.SECONDARY_ASYNC_RULE_RUNNER_FUNCTION_NAME]: {
    codePath: 'async-rule',
    handlerName: 'asyncRuleRunnerHandler',
    expectedMaxSeconds: ASYNC_JOB_LAMBDA_EXPECTED_MAX_SECONDS,
    timeoutSeconds: DEFAULT_ASYNC_JOB_LAMBDA_TIMEOUT_SECONDS,
  ...
  [StackConstants.PRIMARY_ASYNC_RULE_MULTIPLEXER_NAME]: {
    codePath: 'async-rule-multiplexer',
    handlerName: 'asyncRuleMultiplexer',
    expectedMaxSeconds: ASYNC_JOB_LAMBDA_EXPECTED_MAX_SECONDS,
    timeoutSeconds: DEFAULT_ASYNC_JOB_LAMBDA_TIMEOUT_SECONDS,
  },
  [StackConstants.PRE_AGGREGATION_CONSUMER_FUNCTION_NAME]: {
    codePath: 'pre-aggregation-consumer',
    handlerName: 'preAggregationConsumer',
    expectedMaxSeconds: ASYNC_JOB_LAMBDA_EXPECTED_MAX_SECONDS,
    timeoutSeconds: DEFAULT_ASYNC_JOB_LAMBDA_TIMEOUT_SECONDS,
  },
}
